<!DOCTYPE html>
<html>
<body style="background-image:url(images/hbg.jpg)">
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="images/cal.png" width="50px" height="50px"><strong> DENTAL<sup>+</sup></strong>Appointment Booking System</a></li>
					<li><a href="locateus.php">Locate Us</a></li>
					<li><a href="#home">Home</a></li>
				</ul>
			</div>
			<div class="center">
				<p style="text-align:center;"><strong style="color: #660D9F; font-size: 60px">DENTAL<sup>+</sup> </strong></p><br>
				<p style="text-align:center;color:black;font-size:30px; top: 50%;">Online Appointment Booking System</p><br>
				<button class="button button1" type="button" onclick="document.getElementById('id01').style.display='block'" style="position:absolute;top:35%;left:44%">Login</button>

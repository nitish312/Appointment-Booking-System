...
<body style="background-image:url(images/map.png)">
	<div class="header">
		<ul>
	...
	<div class="sucontainer" style="background-image:url(images/map.png)">
		<ul style="background-image:url(images/map.png)">			
